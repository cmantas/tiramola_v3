...
class YCSB_Monitor():
    ...
    def __init__(self, monitoring_endpoint, interval, write_file=False, write_mem=True, measurementsFile = env_vars["measurements_file"]):
    ...
    def load_metrics(self):
        inmetrics = self.monVms.refreshMetrics()
        out_metrics = {}
        ...
        return [Servers.node_count(), out_metrics['inlambda'], out_metrics['throughput'],
                              out_metrics['latency'], out_metrics['cpu'],
...
if __name__ == "__main__":
    ...
    monitor = YCSB_Monitor("83.212.118.57", 3, write_file=True, measurementsFile="dummy.log")
